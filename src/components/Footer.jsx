      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="border-t border-gray-700 pt-8">
          <div className="text-center text-gray-400 text-sm">
            <p>&copy; {currentYear} Deenara. All rights reserved. Built with React & Tailwind CSS</p>
            <p className="mt-2">Made with ❤️ for Portfolio Demonstration</p>
          </div>
        </div>
      </div>
    </footer>
